...
public class LegacyStarDataloader
{
  public class LegacyStar
  {
    ...
    // Constructor
    public LegacyStar(float catalog_number, double right_ascension, double declination, byte spectral_type,
  ...
  public List<LegacyStar> LoadData()
  {
    List<LegacyStar> stars = new();
    ...
    for (int i = 0; i < num_stars; i++)
    {
      ...
      LegacyStar star = new(catalog_number, right_ascension, declination, spectral_type, spectral_index, magnitude, ra_proper_motion, dec_proper_motion);
      stars.Add(star);
    }
